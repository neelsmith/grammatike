...
greek_syntaxer_textinput.py's own manual-entry form works: `urnbase + citation`
...
class CtsDataRow:
    ...
    concatenation greek_syntaxer_textinput.py's manual-entry form uses for its own
